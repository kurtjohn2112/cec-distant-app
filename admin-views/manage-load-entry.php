...
<main class="py-5">
    <div class="container">
        ...
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                <?php if (!empty(get_load())) : ?>
                    <?php foreach (get_load() as $row) : ?>
                        <tr>
                            <td><?php echo $row['fullname'] ?></td>
                            <td><?php echo $row['address'] ?></td>
                            <td><?php echo $row['contact'] ?></td>
                            <td><?php echo show_data('users','id',$row['sender_id'])['fullname'] ?></td>
                            <td><?php echo $row['driver'] ?></td>
                            <td><?php echo $row['est'] ?></td>
                            <td><?php echo $row['weight'] ?></td>
                            <td><?php echo "P ".$row['rate'] ?></td>
                            <!-- <td>
                ...
                <?php else : ?>
                    <tr>
                        <td colspan="5">
                        <div class="alert alert-warning">No loads yet</div>
                        </td>
                    </tr>
                <?php endif; ?>
            </tbody>
